...
class TagFactory(object):
    ...
    def create(cls, type):
        ...
        elif type == 23: return TagDefineButtonCxform()
...
class TagPlaceObject(DisplayListTag):
    ...
    def __init__(self):
        ...
        self.hasClipActions = False
        self.hasClipDepth = False
        self.hasName = False
        self.hasRatio = False
        self.hasColorTransform = False
        self.hasMatrix = False
        self.hasCharacter = False
        self.hasMove = False
        self.hasImage = False
        self.hasClassName = False
        self.hasCacheAsBitmap = False
...
class TagDefineButtonCxform(Tag):
    """
    DefineButtonCxform defines the color transform for each shape and text character in a button.
    This is not used for DefineButton2, which includes its own CXFORM.
    """
    TYPE = 23

    def __init__(self):
        super(TagDefineButtonCxform, self).__init__()

    @property
    def name(self):
        return "TagTagDefineButtonCxform"

    @property
    def type(self):
        return TagDefineButtonCxform.TYPE

    def parse(self, data, length, version=1):
        self.button_id = data.readUI16()
        self.button_color_transform = data.readCXFORM()
